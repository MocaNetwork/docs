...
<CardGroup cols={2}>
  ...
  <Card title="I'm building AI agents" icon="robot" href="/airai/index">
    Make your agent AIR-capable — identity proofs, spend mandates, payment authorization, and audit receipts via MCP, APIs, and plugins.
  </Card>
...
{/* ─── ON-CHAIN IDV/KYC HIGHLIGHT ─────────────────────────────────────── */}
<div class="spotlight">
  <div class="hero--chip">
    On-chain IDV / KYC · Veriff powered by zkMe
  </div>
  <h2 class="spotlight--title">
    <span class="hero--title-accent">Verify once.</span> Reuse across every partner.
  </h2>
  <p class="spotlight--subtitle">
    One IDV/KYC check becomes an AIR Credential on Moca Chain — accepted by every other verifier in the ecosystem. No repeat verification, no multi-party DPAs.
  </p>
  <div class="hero--cta-row">
    <a href="/kyc/index" class="hero--cta-primary">
      Explore on-chain IDV/KYC →
    </a>
    <a href="/kyc/how-it-works" class="hero--cta-secondary">
      How it works
    </a>
  </div>
</div>
...
<CardGroup cols={3}>
  <Card title="On-chain IDV / KYC" icon="id-card" href="/kyc/index">
    Veriff powered by zkMe issues a reusable AIR Credential on Moca Chain — verify once, reuse across every partner without pairwise DPAs.
  </Card>
  <Card title="AI agents" icon="robot" href="/airai/services/index">
    Identity, money, consent, policy, and audit for agents. Let agents act safely on behalf of users — proof handoff, spend mandates, receipts.
  </Card>

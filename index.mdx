...
description: "Issue portable credentials, verify claims with user-controlled disclosure, and plug into Moca Network with a few lines of code."
mode: "custom"
---
    ...
    <div class="content-inner">
      ...
      <section class="hero" aria-labelledby="hero-title">
        <div class="hero__copy">
          ...
          <p class="hero__lead">
            Issue portable credentials, verify claims with user-controlled disclosure, and plug into Moca Network with a few lines of code.
          </p>
          <div class="hero__actions">
            <a href="/airkit/usage/installation" className="air-btn air-btn--primary air-btn--large">Quick setup</a>
            <a href="/learn/architecture" className="air-btn air-btn--outlined air-btn--large">View architecture</a>
          </div>
        </div>
      ...
      <section class="section section--use-cases" aria-labelledby="use-cases-title">
        ...
        <div class="card-grid">
          ...
          <a className="doc-card" href="/solutions/loyalty">
            <span class="doc-card__icon" aria-hidden="true">
          ...
          <a className="doc-card" href="/solutions/gaming">
            <span class="doc-card__icon" aria-hidden="true">
          ...
          <a className="doc-card" href="/solutions/ticketing">
            <span class="doc-card__icon" aria-hidden="true">
          ...
          <a className="doc-card" href="/learn/architecture">
            <span class="doc-card__icon" aria-hidden="true">

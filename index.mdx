        ...
        <div class="hero__visual">
          <section className="quickstart" aria-label="SDK quick start">
            <div className="quickstart__header">
              <div className="quickstart__tabs">
                <div className="air-tabs-track" role="tablist" aria-label="SDK language">
                  ...
                  <button type="button" role="tab" id="landing-tab-react" aria-controls="landing-panel-react" aria-selected="true" tabIndex={0}>React</button>
            ...
            <div className="quickstart__body">
              <div id="landing-panel-react" className="quickstart__code" role="tabpanel" aria-labelledby="landing-tab-react"></div>

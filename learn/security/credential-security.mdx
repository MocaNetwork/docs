...
description: "How Moca Network credentials are signed by issuers, encrypted to the holder, stored as ciphertext, and verified with signature-based proofs — no PII exposure."
---
...
1. The issuer signs the credential data with issuer-controlled signing keys.

---
title: "When to Use AIR"
sidebarTitle: "When to use AIR Kit"
description: "Decision guide for AIR Kit credentials — when verifiable credentials and AIR Account are the right fit for your use case versus traditional auth or APIs."
---

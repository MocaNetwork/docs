---
title: "Use AI assistants to explore AIR Kit docs"
description: "Connect AIR documentation to AI tools via MCP for accurate, up-to-date answers about Moca Network, Moca Chain, and AIR Kit integration."
---
...
Your MCP server provides access to all indexed content on the AIR documentation site. AI applications determine when to use the search tool based on the context of the conversation and the relevance of the documentation.
...
Connect the AIR documentation MCP server to your preferred AI tool:
...
The AIR skill works with any tool that supports the [Agent Skills](https://agentskills.io/home) standard, including Cursor, VS Code Copilot, Gemini CLI, OpenAI Codex, and more.

---
title: "Core Problems"
description: "Core problems Moca Network solves — identity fragmentation, data exploitation, lack of portability, breach risk, and broken loyalty across digital services."
---
...
✅ Moca flips the model—users control credential decryption and disclosure. Raw source documents remain with issuers, while encrypted credential payloads may be stored in DStorage. With **zero-knowledge proofs** and decentralized storage, users can prove facts about themselves without exposing sensitive data.

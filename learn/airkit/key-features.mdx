---
title: "Key Modules"
sidebarTitle: "AIR Account & modules"
description: "AIR Kit core modules — credential management, AIR Account identity, smart accounts, and developer tools that can be used independently or combined."
---
...
- **Issuer signatures and optional on-chain verification**: Issuer signatures protect credential integrity; Verification Programs determine whether proofs are submitted to Moca Chain

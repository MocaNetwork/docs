...
description: "AIR Kit developer features — plug-and-play templates, zero-knowledge privacy, sandbox testing tools, and custom credential schemas for fast integration."
---
...
- **Privacy by Design**: Request only necessary claims and use ZK proofs when underlying values need not be disclosed

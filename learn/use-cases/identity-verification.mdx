...
description: "Privacy-preserving identity verification with AIR Kit — KYC, age gating, and regulatory compliance using verifiable credentials without storing user PII."
---

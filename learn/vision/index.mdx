...
description: "Moca Network's mission is self-sovereign digital identity — one AIR ID that's unified, trusted, private, and portable across apps and chains."
---
...
- **Private** — users control decryption and disclosure of encrypted credentials; raw source documents remain with issuers.

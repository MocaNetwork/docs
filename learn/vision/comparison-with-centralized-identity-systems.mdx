...
description: "Compare centralized identity providers and government IDs against Moca Network's decentralized identity model across privacy, ownership, and portability."
---
...
| **Privacy**        | Data collected, mined, and sold. Governments or platforms act as surveillance hubs.            | **Zero-knowledge proofs (ZKPs)** can prove claims without revealing underlying values. Additional disclosure requires user approval.         |

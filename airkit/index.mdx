...
description: "AIR Kit is the SDK for integrating portable credentials, smart accounts, Web3 login, and zero-knowledge identity verification into web and mobile apps."
---
...
<Note>
  Planning a production launch? Use the production AIR pages and review [Production mainnet access](/airkit/environments#production-mainnet-access). Moca Chain Mainnet is currently private.
</Note>
...
- Fintech teams verifying income, age, or credentials **with limited, user-approved disclosure**

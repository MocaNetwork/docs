...
description: "AIR Kit SDK support matrix — supported platforms, frameworks, browsers, Node.js versions, and module formats for Web, Flutter, and React Native SDKs."
---
...
## On-demand Issuance — Server Language Support

On-demand issuance is HTTP + JWT — any backend language works. Common JWT libraries:

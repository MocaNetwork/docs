...
description: "Enable Google Sign-In in AIR Kit Flutter apps — configure OAuth client IDs in Firebase, set up Info.plist on iOS, and google-services on Android."
---

...
description: "Call EIP-1193 Ethereum JSON-RPC methods through AirService on Flutter — eth_accounts, eth_chainId, eth_sendTransaction, and more for smart account interactions."
icon: "plug"
---

...
description: "Resolve common AIR Kit Flutter integration issues — installation errors, platform configuration, login failures, WebView problems, and SDK initialization."
---

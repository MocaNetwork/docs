---
title: "Install the AIR Kit Flutter SDK"
description: "Install the AIR Kit Flutter SDK via OnePub, configure minimum platform versions for iOS and Android, and add it to your pubspec.yaml."
---
...
<Note>
  Production mobile apps should use the production AIR pages and domains, including `account.air3.com` for passkey setup. Moca Chain Mainnet is private; see [Production mainnet access](/airkit/environments#production-mainnet-access) before requesting mainnet \$MOCA gas tokens.
</Note>

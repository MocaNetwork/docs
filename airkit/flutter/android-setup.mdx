...
Configure your Android app for passkeys, AIR Kit WebViews, and secure networking. These steps align with [SDK installation](/airkit/usage/installation) (Flutter tab).

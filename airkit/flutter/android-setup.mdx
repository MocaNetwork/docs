...
description: "Configure Android for AIR Kit Flutter — Digital Asset Links, AndroidManifest entries, network security config, build.gradle settings, and SHA fingerprints."
---

...
For AIR Kit `issueCredential` and [Direct
Issuance](/airkit/usage/credential/direct-issuance), use a Partner JWT with
these fields. For Direct Issuance, the recipient is resolved through the

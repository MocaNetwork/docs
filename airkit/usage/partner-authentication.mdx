...
description: "Sign a Partner JWT from your backend to authenticate AIR Kit operations — supported algorithms, required claims, JWKS setup, and Issue on Behalf scope."
---
...
| --- | --- | --- |
| Claims | `partnerId`, `scope: "issue on-behalf"`, `email` | `email` must be the **individual target recipient's** AIR Account email — unique per recipient |

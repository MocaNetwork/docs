...
description: "EIP-1193 wallet functions in the AIR Kit Web SDK — interact with EVM chains, manage smart accounts, sign messages, and send transactions from your dApp."
---

...
description: "Create scoped session keys in AIR Kit with air_grantPermissions and air_executeAction — let users approve once then sign transactions without re-prompts (beta)."
---

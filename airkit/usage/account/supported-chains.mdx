...
description: "Supported chains in AIR Kit — list of mainnet and testnet EVM networks available for smart account deployment based on your partner configuration."
---

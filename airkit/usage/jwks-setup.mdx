...
description: "Set up the public HTTPS JWKS endpoint AIR Kit requires for issueCredential, verifyCredential, and Direct Issuance, and register it in the Dashboard."
keywords: ["jwks", "partner jwt", "issueCredential", "verifyCredential", "kid", "direct issuance", "blocking", "prerequisite", "well-known"]
---
...
| Direct Issuance (REST) | Server-to-server | **Yes** |

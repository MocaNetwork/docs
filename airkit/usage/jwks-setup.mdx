...
description: "Set up the public HTTPS JWKS endpoint AIR Kit requires for issueCredential, verifyCredential, and Issue on Behalf, and register it in the Dashboard."

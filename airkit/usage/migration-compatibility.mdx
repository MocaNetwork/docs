...
description: "Browser, Node.js, and framework compatibility requirements for AIR Kit and AIR Kit Connector packages — including passkey support and migration notes."
---

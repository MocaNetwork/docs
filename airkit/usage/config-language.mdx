...
description: "Configure language and currency in AIR Kit — choose available languages, supply custom translations, and set the display currency for your application's UI."
---

---
title: "Install the AIR Kit Web SDK"
description: "Install the AIR Kit Web SDK with npm — @mocanetwork/airkit, available in ESM, CommonJS, and UMD module formats for web app integration."
---
...
<Info>
**Latest version:** `1.10.0` — install with `npm install @mocanetwork/airkit@1.10.0`, or omit the version tag to get the latest release from npm. See [Release notes](/airkit/release-notes) for changes and migration guidance.
</Info>
...
<Note>
  For production mobile apps, keep the production AIR domain (`account.air3.com`) in your Android asset statements and iOS associated domains. Use `account.sandbox.air3.com` for Sandbox testing.
</Note>

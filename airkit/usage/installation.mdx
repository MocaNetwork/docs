...
<Info>
**Latest version:** `1.11.1` — install with `npm install @mocanetwork/airkit@1.11.1`, or omit the version tag to get the latest release from npm. See [Release notes](/airkit/release-notes) for changes and migration guidance.
</Info>

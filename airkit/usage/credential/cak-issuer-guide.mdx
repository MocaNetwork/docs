...
description: "Issuer guide for AIR Kit Compliance Access Key (CAK) — enable CAK encryption, integrate the Issuance SDK, encrypt user data, and handle auth callbacks."
---
...
|-----------|------|----------|-------------|
| `authToken` | `string` | Yes | Partner JWT validated through your registered JWKS |

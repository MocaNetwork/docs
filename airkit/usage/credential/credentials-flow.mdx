...
See [Issuing Credentials](/airkit/usage/credential/issuing-credentials) for the hosted Issuer Backend path, or [Issue on Behalf](/airkit/usage/credential/issue-on-behalf) for the script-based direct issuance path.

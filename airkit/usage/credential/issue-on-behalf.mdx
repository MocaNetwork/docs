...
description: "Issue AIR Kit credentials server-side without an active user session — push credentials to user AIR Accounts on backend events like KYC pass or tier change."
tag: "NEW"
---

...
description: "Create and publish AIR Kit credential schemas using the Schema Builder — define fields, types, validation rules, and JSON-LD context without code."
---

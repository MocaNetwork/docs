...
description: "Evolve AIR Credential schemas safely with backward-compatible versioning — strategies for adding fields, deprecation, and migrating existing credentials."
---

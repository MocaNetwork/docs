...
description: "AIR Kit Compliance Access Key (CAK) — an optional consent-gated encryption framework for regulated data access in the verifiable credential lifecycle."
---

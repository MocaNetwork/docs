...
description: "Issue AIR credentials directly from a script or backend job — resolve the user, sign the VC, encrypt to the holder, and store in DStorage without a live issuer."
tag: "NEW"
---

...
description: "Initialize the AIR Kit SDK in Web and Flutter apps — create the AirService instance, configure the build environment, and preload wallet and credential modules."
---

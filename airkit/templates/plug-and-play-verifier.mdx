...
description: "Fork, configure, and deploy the AIR Credential Verifier template — a ready-to-use verifier app for checking AIR Credentials with zero-knowledge proofs."
---

...
description: "Switch between AIR Kit Sandbox and Production environments — Sandbox is Moca Chain Testnet; Production supports Testnet or private Mainnet via credentialNetwork."
---

<Warning>
Sandbox always uses **Moca Chain Testnet**. Passing `credentialNetwork` with `BUILD_ENV.SANDBOX` is no longer needed.
</Warning>
...
| Production + `credentialNetwork: "mainnet"` | Private Mainnet (2288) | Approved production launches | https://developers.air3.com/dashboard |
...
Moca Chain Mainnet is currently a private mainnet. Approved production launches should use the production AIR pages, including the [production Developer Dashboard](https://developers.air3.com/dashboard), and configure AIR Kit with `BUILD_ENV.PRODUCTION`.

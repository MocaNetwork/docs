...
<Info>
  ...
  [Direct Issuance and Pre-issue](/learn/architecture#direct-issuance-and-pre-issue-flow).
</Info>
...
See [Architecture and data flow](/learn/architecture) for the sequence diagram.

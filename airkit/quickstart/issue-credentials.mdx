...
description: "Issue verifiable credentials with AIR Kit — define a schema, configure an issuance program, and trigger client-side credential issuance to user AIR Accounts."
---

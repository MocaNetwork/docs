...
This guide covers client-side credential issuance using the AIR Kit SDK. For server-side credential issuance without user interaction, see [Issue Credentials on Behalf](/airkit/usage/credential/direct-issuance).
</Info>

...
- Two public HTTPS origins, or HTTPS tunnels, for your issuer backend and web
  app
- Contact to the AIR team for issuer activation and backend
  whitelisting

<Warning>
  Hosted issuer backends are not fully self-service. AIR must register your
  Issuer DID, API key, Partner ID, and issuer endpoint URLs before the
  Credential API will call your backend.
</Warning>

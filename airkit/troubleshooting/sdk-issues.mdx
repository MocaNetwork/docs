---
title: "SDK Issues"
description: "Troubleshoot AIR Kit SDK issues — initialization failures, login problems, session expiry, partner config errors, and runtime errors in Web and Flutter apps."
---

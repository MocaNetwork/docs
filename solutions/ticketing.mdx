...
description: "Turn every venue scan into a portable attendance credential fans can reuse for rewards, presales, and partner access — with user-controlled disclosure to partners."
---
...
{/* TODO: Expand this business overview with problem framing, compliance Q&A, and an integration-at-a-glance table, matching the other verticals. Content below is derived from the developer guide. */}

## What Changes With AIR Kit

- **Every scan becomes a credential** — Venue check-in issues a verifiable "attended this event" proof into the fan's AIR Account. No app to open, no action from the fan
- **Fan loyalty without a new program** — Fans who reach an attendance threshold can be upgraded to a "Loyal Fan" credential automatically
- **Gated access that partners can trust** — VIP lounges, meet-and-greets, and presales unlock for verified attendees. The verifier learns only that the fan qualifies
- **Cross-brand fan benefits** — Merchandise, hotel, and streaming partners accept the attendance credential directly. No bilateral API between you and each partner
- **Anti-scalping** — Secondary ticket access can be gated behind an attendance credential from a prior event

## What Your Fans Experience

Nothing changes at the door. The fan scans in as they do today; the credential issues silently in the background.

Later, at a partner or your own presale, the fan authenticates with their AIR Account and the benefit unlocks. No code to enter, no account linking.

## Next Steps

<CardGroup cols={2}>
  <Card title="Compliance FAQ" icon="shield-check" href="/solutions/compliance-faq">
    GDPR, PII, and data residency answers.
  </Card>
...
<Columns cols={2}>
  <Card title="AIR for Loyalty & Rewards" icon="gift" href="/solutions/loyalty">
    Build tier-based loyalty on top of attendance credentials.
  </Card>

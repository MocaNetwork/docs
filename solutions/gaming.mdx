...
Your schema defines the claims. This example uses game ID, achievement name, tier, and timestamp. These can still be personal data when linked to a player. Credential payloads are encrypted in DStorage, and users control decryption and disclosure.
...
Review your terms and privacy notice for encrypted credential storage, cross-platform verification, and user-controlled disclosure. Confirm that the purposes, recipients, and retention of achievement data are covered by your agreements and applicable requirements.
...
<CardGroup cols={2}>
  ...
  <Card title="ZK Age Verification — Verifier" icon="github" href="https://github.com/MocaNetwork/air-examples/tree/main/zk-age-verification/verifier">
    iGaming or age-gated app: verifies age via ZK proof and grants access; no birthdate disclosure required.
  </Card>
</CardGroup>

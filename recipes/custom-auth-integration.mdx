...
description: "Skip the AIR Kit login dialog and pass users from your existing auth (Firebase, Auth0, Supabase, or custom) into AIR Kit sessions using a Partner JWT."
---
...
4. AIR Kit creates or resolves the user's AIR Account and session, skipping the built-in login UI.

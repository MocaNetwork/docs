---
title: "Bring your own auth with a Partner JWT"
description: "Skip the AIR Kit login dialog and pass users from Firebase, Auth0, Supabase, or your custom auth into AIR Kit sessions using a Partner JWT."
---
...
Include `email` alongside `partnerId`:

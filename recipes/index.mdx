---
title: "Recipes"
description: "Task-oriented AIR Kit recipes — focused, copy-paste guides for KYC issuance, loyalty credentials, custom auth, wagmi, and verification flows."
---
...
<CardGroup cols={2}>
  <Card title="Issue a KYC credential on a backend event" icon="webhook" href="/recipes/kyc-credential-on-event">
    Wire a KYC-complete webhook to Direct Issuance so credentials appear in user accounts automatically.
  </Card>

...
This recipe shows how to issue a verifiable KYC credential the moment your identity provider confirms a user, using [Direct Issuance](/airkit/usage/credential/direct-issuance) script-based direct issuance. The user never needs to be in an active session.

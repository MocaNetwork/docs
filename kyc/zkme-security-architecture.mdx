...
description: "How zkMe protects identity data behind Veriff powered by zkMe: zkPassport trust anchors, zkVault encryption, homomorphic face matching, and zero-knowledge credentials — aligned with AIR Kit on Moca Chain."
icon: "shield-halved"
---

The content below summarizes **public zkMe Protocol documentation** in language consistent with Moca Network. It explains how **zkMe Labs** can act as a **credential Issuer** for **Veriff powered by zkMe** while keeping partner systems free of raw KYC media. For the canonical technical detail, see [zkMe docs — Architecture](https://docs.zk.me/hub/how-works/architecture) and [zkPassport](https://docs.zk.me/hub/how-built/id-infra/zkpassport).
...
Partners on Moca still receive **AIR Credentials** and **ZK verification results**; they do not host zkVault.
...
- **Selective disclosure** patterns so holders prove specific predicates without revealing full claim dictionaries.
- **Anti-sybil** tooling such as **nullifiers** where "one person, one action" guarantees matter.

On **Moca Network**, your integration still lands as an **AIR Credential** with on-chain anchoring and AIR Kit verifier flows — the zkMe cryptographic stack sits **behind** Issuance operated by zkMe Labs for this product bundle.

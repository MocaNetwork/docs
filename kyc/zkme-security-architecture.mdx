...
description: "How zkMe protects identity data behind Veriff powered by zkMe: zkPassport trust anchors, zkVault encryption, homomorphic face matching, and on-chain credential proofs — aligned with AIR Kit on Moca Chain."
icon: "shield-halved"
---

...
description: "End-to-end flow: user verification, programmatic and manual paths, AML screening, credential issuance to the AIR Account, and verifier outcomes — configured per program for pass/fail, selective attributes, or full raw data with consent."
icon: "route"
---
...
<CardGroup cols={2}>
  <Card title="Overview" icon="book" href="/kyc/index">
    Disclosure flexibility and what is included in the bundle.
  </Card>

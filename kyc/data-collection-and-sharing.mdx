...
description: "What Veriff powered by zkMe collects from users, what Moca partners receive, what is anchored on Moca Chain, and how pass/fail, selective disclosure, and full raw data (via CAK) are configured per program."
icon: "database"
---
...
Exact fields depend on the verification program configured for your partnership. **Your application does not need to persist these artifacts** to participate in the AIR credential model unless your own compliance policy requires local copies.
...
End-user verification sessions for **Veriff powered by zkMe** may execute on infrastructure operated under zkMe' commercial and technical arrangements. Outputs are consumed by **zkMe** as the **legal and contracting party** for your Moca-facing KYC bundle. Partners contract for this path with **zkMe** only.

...
description: "Moca Chain architecture overview — EVM-compatible Layer 1 built on EVMOS and CometBFT consensus, paired with the MCSP decentralized storage network."
---

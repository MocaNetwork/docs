...
description: "Moca Chain Storage Providers (MCSPs) — decentralized data storage for credentials, including provider lifecycle, data integrity, and payment flows."
---
...
- **Quota & Price**:
  ...
  - `store_price`: The cost in Gwei per byte per second for data storage.

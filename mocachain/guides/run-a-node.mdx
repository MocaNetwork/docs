...
description: "Run a Moca Chain full node using Docker or Cosmovisor — system requirements, snapshot bootstrap, configuration, and ongoing maintenance for operators."
---
...
| ------- | ------------- | ------------ | --------------------------------- |
| Mainnet | moca_2288-1   | 2288         | https://tm-rpc.mocachain.org      |
| Testnet | moca_222888-1 | 222888       | https://tm-rpc.testnet.mocachain.dev |

...
description: "Run a Moca Chain Storage Provider (MCSP) — hardware requirements, registration, staking, on-chain bonding, and operational setup for storing credential data."
---

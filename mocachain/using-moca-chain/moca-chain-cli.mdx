...
description: "Use the Moca Chain CLI to manage Cosmos accounts, basic storage operations, and direct interaction with the Moca Chain network from your terminal."
---

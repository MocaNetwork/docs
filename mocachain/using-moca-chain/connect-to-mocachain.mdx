...
description: "Connect your Web3 wallet to Moca Chain — configure MetaMask and other EVM wallets, deploy an AIR Account, and start interacting with the network."
---

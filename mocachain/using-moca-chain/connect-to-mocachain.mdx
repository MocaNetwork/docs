...
description: "Connect a Web3 wallet to Moca Chain Mainnet or Testnet — configure MetaMask and other EVM wallets, deploy an AIR Account, and interact with the network."
---
